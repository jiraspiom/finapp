...
authRoutes.patch("/me", authenticate, zValidator("json", z.object({
...
async function createDefaultCategories(userId: string) {
  const defaults = [
    ...
    { name: "Outros (Receita)", type: "INCOME" as const, color: "#06b6d4", icon: "💰" },
    { name: "Alimentação", type: "EXPENSE" as const, color: "#f59e0b", icon: "🍽️" },
    { name: "Transporte", type: "EXPENSE" as const, color: "#ef4444", icon: "🚗" },
    { name: "Moradia", type: "EXPENSE" as const, color: "#f97316", icon: "🏠" },
    { name: "Saúde", type: "EXPENSE" as const, color: "#ec4899", icon: "🏥" },
    { name: "Educação", type: "EXPENSE" as const, color: "#14b8a6", icon: "📚" },
    { name: "Lazer", type: "EXPENSE" as const, color: "#a855f7", icon: "🎮" },
    { name: "Compras", type: "EXPENSE" as const, color: "#f43f5e", icon: "🛍️" },
    { name: "Outros (Despesa)", type: "EXPENSE" as const, color: "#64748b", icon: "📦" },
  ]
